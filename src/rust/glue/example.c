...
static int
handle_nk_rust_example(char* buf, void* priv) {
...
static struct shell_cmd_impl nk_rust_example_impl = {
    .cmd = "rust",
    .help_str = "rust",
    .handler = handle_nk_rust_example,
};
nk_register_shell_cmd(nk_rust_example_impl);
