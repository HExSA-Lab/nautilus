                    ...
                    Context ctx, HighLevelRuntime *runtime)
{
  ...
  printk("Running stencil computation for %d elements...\n", num_elements);
                  ...
                  Context ctx, HighLevelRuntime *runtime)
{
  ...
  {
    printk("Running slow stencil path for point %d...\n", point);
  ...
  {
    printk("Running fast stencil path for point %d...\n", point);
...
int go_multi(int argc, char **argv);
int go_multi(int argc, char **argv)
{
...
extern "C" void go_multi_c (int argc, char ** argv) {
    go_multi(argc, argv);
}
