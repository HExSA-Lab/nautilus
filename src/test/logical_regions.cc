                    ...
                    Context ctx, HighLevelRuntime *runtime)
{
  ...
  printk("Created unstructured index space %x\n", unstructured_is.id);
  ...
  printk("Created structured index space %x\n", structured_is.id);
  ...
  // its points.
  {
    ...
    printk("Allocated elements in unstructured "
           "space at ptr_t %d\n", begin.value);
  ...
  printk("Created field space field space %x\n", fs.get_id());
  ...
  // the Legion runtime will report an error and exit.
  {
    ...
    printk("Allocated two fields with Field IDs %d and %d\n", fida, fidb);
  }
  ...
  printk("Created unstructured logical region (%x,%x,%x)\n",
  ...
  printk("Created structured logical region (%x,%x,%x)\n",
  ...
  printk("Successfully cleaned up all of our resources\n");
}

int go_log_regs(int argc, char **argv);
int go_log_regs(int argc, char **argv)
{
...
extern "C" void go_log_regs_c(int argc, char ** argv) {
    go_log_regs(argc, argv);
}
