...
static yyconst flex_int16_t yy_accept[28] =
    {   0,
        0,    0,   14,   12,   11,   10,    5,   12,    7,    8,
        5,    1,    3,    4,   12,    5,    0,    6,    1,    2,
        0,    9,    2,    5,    5,    2,    0
    } ;
...
// Temporary hack to embed a program into the vinterp library

extern char *programstr;

#define YY_INPUT(buf,result,max_size) { result = (*programstr == 0) ? YY_NULL : (buf[0] = *programstr++, 1); } 
